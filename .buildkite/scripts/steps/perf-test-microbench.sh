...
# PARTIAL include drift (a rename of one of the five classes yields fewer rows and,
# being non-gating, would otherwise pass unnoticed). The five default classes emit,
