...
|---|---|---|---|
| Standard Docker image, `docker run` → ready | 855 ms (7.5.0) | 566 ms (AppCDS) | −34% |
...
published 7.5.0 standard image **855 ms** (−34%; −39% vs a same-jar no-AppCDS control at 933 ms).
