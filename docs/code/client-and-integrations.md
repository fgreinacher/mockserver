...
| Default version | the last released MockServer version (`7.6.0`) — see *Version pinning* below |
...
which can treat `7.6.0` and `7.6.0-SNAPSHOT` as equal — prune order between those two is not
